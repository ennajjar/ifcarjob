...
<div class="row mg-container bg-grey1">
	<div class="col-md-6 col-md-offset-3">
		<form class="form-signin mg-btm">
			<h1 class="heading-desc text-center">Nouveau recruteur</h1>
			...
			<div class="main-form-register">
				<label class="radio-inline"> <input type="radio" name="gender" id="gender" value="mr">Mr </label>
				...
				<div class="row">
					<div class="col-md-6"><input type="text" class="form-control" placeholder="Société*"></div>
